...
<div class="container_F">
    ...
    <div class="friendWrapper">
        ...
        <div class="friendTabMenu">
            <button type="button" class="friend-tab-button active" data-tab="my">내 친구</button>
            <button type="button" class="friend-tab-button" data-tab="recommend">친구 추천</button>
        </div>
        ...
        <div class="friendTabContent">
            ...
            <div id="tab-my" class="friendTabPane active">
                <div class="friendTitle"><h2>내 친구 목록</h2></div>
            ...
            <div id="tab-recommend" class="friendTabPane">
                <div class="friend_RandomTitle"><h2>친구 추천 목록</h2></div>
